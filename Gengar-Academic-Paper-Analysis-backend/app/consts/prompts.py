...
1. **Analyze and Identify**  
   - **Logical/Conceptual Errors**: Review arguments, conclusions, and key assertions for logical flaws, oversimplifications, irrelevant information, and anthropomorphism.
   - **Methodological Errors**: Assess experimental design, sampling methods, controls, and analysis techniques for flaws or unexplained deviations from standard practices.
   - **Calculation Errors**: Examine statistical and numerical computations for incorrect formulas, statistical miscalculations, or improper data normalization.
   - **Data Inconsistencies**: Identify discrepancies in datasets, participant counts, or results conflicting with reported data.
   - **Citation/Reference Issues**: Detect missing citations, outdated references, or incorrect formatting of sources.
   - **Formatting Errors**: Review compliance with journal guidelines, layout consistency, and appropriate use of styles and headings.
   - **Ethical Concerns**: Evaluate adherence to ethical guidelines, participant consent, conflict-of-interest declarations, and data privacy standards.

2. **Provide Structured Findings**  
   For each identified error, include:
   - **Issue**: A concise description of the problem.
   - **Implications**: The potential impact or significance of the issue.
   - **Recommendation**: How to resolve or mitigate the issue.
...
1. **Logical/Conceptual Errors**  
   - **Issue**: "The conclusion 'X implies Y' lacks sufficient evidence."  
   - **Implications**: "Readers may incorrectly assume causation where only correlation exists."  
   - **Recommendation**: "Include robust data or reframe the conclusion."

2. **Methodological Errors**  
   - **Issue**: "No randomization procedure described for treatment groups."  
   - **Implications**: "Selection bias undermines internal validity."  
   - **Recommendation**: "Implement a clear randomization strategy."

3. **Calculation Errors**  
   - **Issue**: "Incorrect application of the Chi-square test."  
   - **Implications**: "Inflated p-value risks Type II errors."  
   - **Recommendation**: "Verify degrees of freedom and expected frequency assumptions."

4. **Data Inconsistencies**  
   - **Issue**: "Participant count in Table 3 conflicts with main text."  
   - **Implications**: "Undermines study reliability."  
   - **Recommendation**: "Reconcile reported figures."

5. **Citation/Reference Issues**  
   - **Issue**: "Key claims lack supporting citations."  
   - **Implications**: "Readers may question validity."  
   - **Recommendation**: "Add appropriate peer-reviewed references."

6. **Formatting Errors**  
   - **Issue**: "Figures embedded in text instead of placed after references."  
   - **Implications**: "Misaligned with submission guidelines."  
   - **Recommendation**: "Relocate figures per journal requirements."
